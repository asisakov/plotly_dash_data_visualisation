...
def avgprice(variety):
    var = variety
    dff = transforms.top_df_prep
    avgprice = dff[dff['MONTH'] == var]['AVG_PAID_AMOUNT']
    
    return avgprice.round(2)
...
def records(variety):
    var = variety
    dff = transforms.top_df_prep
    records = dff[dff['MONTH'] == var]['NUMBER_OF_TRANSACTIONS']
